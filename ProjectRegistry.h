...
class ProjectRegistry {
    ...
    //Factory Methods
    void createProject(const std::string& id, const std::string& name, const std::string& desc = "");
    void createIssue(const std::string& id, const std::string& name, const std::string& desc = "");
    ...
    //Decoration
    void decorateIssue(const std::string& issueId, std::unique_ptr<IssueDecorator> decorator);
